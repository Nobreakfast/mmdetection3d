...
anchor_ranges = [
    ...
    # [-51.2, -51.2, -0.6, 51.2, 51.2, -0.6],
    # [-51.2, -51.2, -0.6, 51.2, 51.2, -0.6],
    # [-51.2, -51.2, -1.78, 51.2, 51.2, -1.78],
]
anchor_sizes = [
    [0.8, 0.6, 1.73],
    [1.76, 0.6, 1.73],
...
train_pipeline = [
    ...
    # dict(type="Resize", scale=tuple(image_size2), keep_ratio=False),
